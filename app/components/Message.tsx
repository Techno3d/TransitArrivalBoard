...
export function Message(props: { routes: Record<string, Route>; name: string; headers: Array<string>; index: number }) {
  return (
    <React.Fragment>
      ...
      {props.headers.length > 0 ? (
        <div className="flex min-h-[140px] flex-row items-start rounded-lg bg-slate-100 px-4">
          <h1 className="line-clamp-2 text-pretty font-semibold 2xl:text-5xl 2xl:leading-tight">
        ...
        <div className="flex min-h-[140px] flex-row items-center rounded-lg bg-slate-100">
