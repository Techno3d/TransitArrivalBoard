  ...
  return (
    <React.Fragment>
      <div className="flex h-full basis-1/3 flex-col items-center gap-2">
        <div className="flex h-14 w-full flex-row items-center justify-center rounded-lg bg-[#B9D9EB]">
        ...
        <div className="flex w-full grow flex-col items-center gap-2 rounded-lg bg-slate-100 p-2">
          ...
          <div className="flex aspect-square h-14 items-center justify-center rounded-full bg-[#B9D9EB]">
            <h1 className="font-semibold text-slate-100 2xl:text-4xl">7</h1>
          </div>
          <div className="line-clamp-2 flex h-21 w-full items-center justify-center rounded-lg bg-[#B9D9EB] px-2">
